...
export function PriceComparison({ basePrice, competitors, route, onBookNow, onPriceMatch }: PriceComparisonProps) {
  ...
  if (showPriceMatch) {
    return (
      <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-gray-800 dark:to-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-yellow-300 dark:border-yellow-700">
        <div className="text-center mb-4 sm:mb-5 md:mb-6">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-yellow-500 rounded-full mb-2 sm:mb-3">
        ...
        <div className="space-y-3 sm:space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-base sm:text-lg font-semibold focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
            />
            {error && (
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-yellow-500 to-amber-500 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold hover:from-yellow-600 hover:to-amber-600 transition-all shadow-lg"
            >
              Continue with ${customPrice || '0'}
            </button>
            <button
              onClick={() => setShowPriceMatch(false)}
              className="px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
            >
              Back
            </button>
          </div>
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-green-300 dark:border-green-700">
      <div className="text-center mb-4 sm:mb-5 md:mb-6">
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-green-500 rounded-full mb-2 sm:mb-3">
          <span className="text-2xl sm:text-2xl md:text-3xl">✓</span>
        </div>
        <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2 px-2">
      ...
      <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5 md:mb-6">
        {allPrices.map((item, index) => {
          ...
          return (
            <div
              key={item.name}
              className={`rounded-lg sm:rounded-xl p-3 sm:p-4 transition-all duration-300 ${
                isOurs
                  ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-xl sm:scale-105 border-2 border-green-400'
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl p-4 sm:p-5 border-2 border-green-500 mb-4 sm:mb-5 md:mb-6">
        <div className="text-center">
          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 px-2">
      ...
      <div className="space-y-2 sm:space-y-3">
        <button
          onClick={onBookNow}
          className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold text-base sm:text-lg hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg flex items-center justify-center gap-2"
        >
          <span>✓</span>
        ...
        <button
          ...
          className="w-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center justify-center gap-2"
        >
          <span>🔁</span>
